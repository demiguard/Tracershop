...
export const JAVASCRIPT_VERSION = "2.4.5";
...
export const WEBSOCKET_MESSAGE_FREE_ISOTOPE = "freeIsotope";
...
export const WEBSOCKET_MESSAGE_MODELS_DELETE = "deleteModel";
export const WEBSOCKET_MESSAGE_MODELS_EDIT = "editModel";
