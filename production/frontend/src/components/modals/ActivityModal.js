...
import { ERROR_LEVELS, AlertBox } from "../injectables/AlertBox";
...
import { ClickableIcon } from "../injectables/Icons";
import { CompareDates as compareDates } from "../../lib/utils";
import { JSON_ACTIVITY_ORDER, JSON_VIAL, WEBSOCKET_DATA, WEBSOCKET_DATATYPE, WEBSOCKET_MESSAGE_CREATE_DATA_CLASS, WEBSOCKET_MESSAGE_EDIT_STATE } from "../../lib/constants";
import { batchNumberValidator, FormatTime, ParseDanishNumber } from "../../lib/formatting";
  ...
  renderVialTable(){
    ...
    <div>
      ...
      <div className="flex-row-reverse d-flex">
        {(this.state.addingVial) ? "" : <div>{<ClickableIcon src={"/static/images/plus.svg"} onClick={this.startAddingVial.bind(this)}/>}</div>}
      </div>
    </div>)
  }
