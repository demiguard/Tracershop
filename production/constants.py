...
DATETIME_PATTERN = fr"^{DATE_PATTERN}[^\d]?{TIME_PATTERN}$"
DATETIME_UTC_PATTERN = fr"^{DATE_PATTERN}[^\d]?{TIME_PATTERN}Z$"
DATETIME_PATTERN_WITH_MICRO = fr"^{DATE_PATTERN}[^\d]?{TIME_PATTERN}\.(\d+)$"
DATETIME_PATTERN_WITH_MICRO_TZ_PLUS = fr"^{DATE_PATTERN}[^\d]?{TIME_PATTERN}\.(\d+)\+(\d{{2}})[^\d]?(\d{{2}})$"
DATETIME_PATTERN_WITH_MICRO_TZ_MINUS = fr"^{DATE_PATTERN}[^\d]?{TIME_PATTERN}\.(\d+)\-(\d{{2}})[^\d]?(\d{{2}})$"

DATETIME_RE_UTC = re.compile(DATETIME_UTC_PATTERN)
DATETIME_REGULAR_EXPRESSION = re.compile(DATETIME_PATTERN)
DATETIME_RE_WITH_MICRO = re.compile(DATETIME_PATTERN_WITH_MICRO)
DATE_REGULAR_EXPRESSION = re.compile(DATE_FORMAT)
TIME_REGULAR_EXPRESSION = re.compile(TIME_PATTERN)
DATETIME_RE_WITH_MICRO_TZ_PLUS = re.compile(DATETIME_PATTERN_WITH_MICRO_TZ_PLUS)
DATETIME_RE_WITH_MICRO_TZ_MINUS = re.compile(DATETIME_PATTERN_WITH_MICRO_TZ_MINUS)
