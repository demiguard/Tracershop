...
class WEBSOCKET_MESSAGE_TYPES(__Enum):
  ...
  WEBSOCKET_MESSAGE_GET_STATE = WEBSOCKET_MESSAGE_GET_STATE
  ...
  WEBSOCKET_MESSAGE_GET_BOOKINGS = WEBSOCKET_MESSAGE_GET_BOOKINGS
  WEBSOCKET_MESSAGE_GET_TELEMETRY = WEBSOCKET_MESSAGE_GET_TELEMETRY
