...
JAVASCRIPT_VERSION = "2.0.3" # Remember to update this to catch bugs
...
class WEBSOCKET_MESSAGE_TYPES(__Enum):
  ...
  WEBSOCKET_MESSAGE_GET_STATE = WEBSOCKET_MESSAGE_READ_STATE
  ...
  WEBSOCKET_MESSAGE_GET_BOOKINGS = WEBSOCKET_MESSAGE_READ_BOOKINGS
  WEBSOCKET_MESSAGE_GET_TELEMETRY = WEBSOCKET_MESSAGE_READ_TELEMETRY
